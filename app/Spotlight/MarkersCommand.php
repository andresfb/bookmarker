...
class MarkersCommand extends SpotlightCommand
{
     ...
     */
    protected string $name = 'Markers Search';

    /**
     * This is the description of your command which will be shown besides the command name.
     */
    protected string $description = 'Search for Markers';
     ...
     */
    public function searchMarker($query): Collection
    {
     ...
     */
    public function execute(Spotlight $spotlight, Marker $marker): void
    {
        $spotlight->redirectRoute('marker', $marker->slug);
    }
