            ...
            <div class="drawer-side">
                ...
                <aside class="bg-base-200 w-80">
                    <div class="z-20 bg-base-200 bg-opacity-90 backdrop-blur sticky top-0 items-center gap-2 px-4 py-2 hidden lg:flex">
                        <a href="{{ route('dashboard') }}" aria-current="page" aria-label="Dashboard" class="flex-0 btn btn-ghost px-2">
                            <div class="inline-flex transition-all duration-200 md:text-3xl">
                                <span class="mt-2 mr-2 text-primary">
                                    <svg viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8">
                                        <path fill-rule="evenodd" d="M6.32 2.577a49.255 49.255 0 0111.36 0c1.497.174 2.57 1.46 2.57 2.93V21a.75.75 0 01-1.085.67L12 18.089l-7.165 3.583A.75.75 0 013.75 21V5.507c0-1.47 1.073-2.756 2.57-2.93z" clip-rule="evenodd" />
                                    </svg>
                                </span>
                                <span class="text-gray-700">{{ config('app.name') }}</span>
                            </div>
                        </a>
                    </div>
                    ...
                    <ul class="menu menu-compact flex flex-col p-0 px-4 space-y-4">
                        ...
                        <li>
                            <a href="#" id="archived" class="flex gap-4">
                                <span class="flex-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        ...
                        <li>
                            <a href="#" id="hidden" class="flex gap-4">
                                <span class="flex-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    ...
                    <ul class="menu menu-compact flex flex-col p-0 px-4 space-y-2">
                        ...
                        <li>
                            <a href="#" id="general" class="flex gap-4">
                                General
                            </a>
                        </li>
                        <li>
